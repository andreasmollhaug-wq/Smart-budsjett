...
Denne mappen samler **Markdown-filer** som beskriver produktet, prising, landing, design og teknisk oversikt — uavhengig av React-koden. Bruk dem som sannhetskilde når dere oppdaterer nettsiden, vilkår eller salgsmateriell.

| Fil | Formål |
|-----|--------|
| [PRODUKT.md](./PRODUKT.md) | Hva produktet er, for hvem, verdiforslag og merke |
| [LANDING.md](./LANDING.md) | Struktur og budskap på forsiden (`/`) |
| [PRIS-OG-ABONNEMENT.md](./PRIS-OG-ABONNEMENT.md) | Planer, priser, prøveperiode og kort |
...
| [ARKITEKTUR.md](./ARKITEKTUR.md) | Next.js, mapper, state |

**Juridisk innhold** skal ligge på egne sider i appen. Det finnes foreløpig stubber under:
