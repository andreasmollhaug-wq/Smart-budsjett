  ...
  function notifyAfterRemoval(res: RemoveLedgerImportRunResult) {
    ...
    if (res.mode === 'historyOnly') {
      addAppNotification({
        ...
        body: 'Transaksjonene fra bankimporten er beholdt.',
        kind: 'budget',
      })
      return
    }
    ...
    if (res.orphanFullRemoval) {
      addAppNotification({
        ...
        body:
          'Fant ingen tilknyttede transaksjoner for denne importen. Bare historikkposten ble fjernet.',
        kind: 'budget',
      })
      return
    }
        ...
        >
          ...
          >
            ...
            <p className="text-sm mb-3" style={{ color: 'var(--text-muted)' }}>
              ...
              ble opprettet av denne kjøringen.
            </p>
