    ...
    >
      ...
      <div className="relative min-w-0">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span
            className="inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-[0.65rem] font-medium sm:text-xs"
            style={{ background: 'var(--bg)', color: 'var(--text-muted)', border: '1px solid var(--border)' }}
          >
            <LayoutDashboard size={13} aria-hidden />
            Kun autoriserte viewers
          </span>
        </div>
        ...
        <p className="mt-3 max-w-2xl text-sm leading-relaxed sm:text-base" style={{ color: 'var(--text-muted)' }}>
          Her følger du vekst, konvertering og abonnement — aggregerte tall uten persondata. Oppdateres når du
          laster siden.
        </p>
      </div>
    </section>
