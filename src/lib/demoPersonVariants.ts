...
const VARIANT_1: DemoVariantBody = {
  ...
  savingsGoals: [
    { id: '1', name: 'Feriefond', targetAmount: 14_000, currentAmount: 4_200, targetDate: '2026-07-01', color: '#3B5BDB' },
    { id: '2', name: 'Nødfond', targetAmount: 35_000, currentAmount: 9_500, targetDate: '2026-12-01', color: '#0CA678' },
    { id: '3', name: 'Kontantinsats', targetAmount: 120_000, currentAmount: 18_000, targetDate: '2027-06-01', color: '#F08C00' },
  ],
  debts: [
    {
      id: '1',
...
const VARIANT_2: DemoVariantBody = {
  ...
  savingsGoals: [
    { id: '1', name: 'Feriefond', targetAmount: 85_000, currentAmount: 52_000, targetDate: '2026-07-01', color: '#3B5BDB' },
    { id: '2', name: 'Nødfond', targetAmount: 250_000, currentAmount: 142_000, targetDate: '2026-12-01', color: '#0CA678' },
    { id: '3', name: 'Hyttedrøm', targetAmount: 450_000, currentAmount: 195_000, targetDate: '2028-06-01', color: '#F08C00' },
  ],
  debts: [
    {
      id: '1',
...
const VARIANT_3: DemoVariantBody = {
  ...
  savingsGoals: [
    { id: '1', name: 'Feriefond', targetAmount: 22_000, currentAmount: 8_800, targetDate: '2026-07-01', color: '#3B5BDB' },
    { id: '2', name: 'Nødfond', targetAmount: 75_000, currentAmount: 31_000, targetDate: '2026-12-01', color: '#0CA678' },
    { id: '3', name: 'Bil', targetAmount: 180_000, currentAmount: 45_000, targetDate: '2027-03-01', color: '#F08C00' },
  ],
  debts: [
    {
      id: '1',
...
const VARIANT_4: DemoVariantBody = {
  ...
  savingsGoals: [
    { id: '1', name: 'Feriefond', targetAmount: 35_000, currentAmount: 14_500, targetDate: '2026-07-01', color: '#3B5BDB' },
    { id: '2', name: 'Nødfond', targetAmount: 120_000, currentAmount: 62_000, targetDate: '2026-12-01', color: '#0CA678' },
    { id: '3', name: 'Oppussing', targetAmount: 95_000, currentAmount: 22_000, targetDate: '2026-10-01', color: '#F08C00' },
  ],
  debts: [
    {
      id: '1',
