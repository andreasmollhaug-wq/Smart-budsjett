...
export const PRODUCT_ANNOUNCEMENTS: ProductAnnouncement[] = [
  {
    id: 'release-0.1.0',
    version: '0.1.0',
    title: 'Velkommen til Dottir v0.1',
    body:
  ...
  },
  {
    id: 'release-0.3.3',
    version: '0.3.3',
    title: 'Dottir v0.3.3 er ute — viktig fiks for CSV-import av beløp',
    body:
  ...
  },
  {
    id: 'release-0.3.4',
    version: '0.3.4',
    title: 'Dottir v0.3.4 — transaksjoner og budsjettkategorier',
    body:
  ...
  },
  {
    id: 'release-0.3.5',
    version: '0.3.5',
    title: 'Dottir v0.3.5 — månedsinnsikt og smartere AI',
    body:
  ...
  },
  {
    id: 'release-0.3.6',
    version: '0.3.6',
    title: 'Dottir v0.3.6 — ny Oversikt og profiler under Min konto',
    body:
  ...
  },
  {
    id: 'release-0.3.8',
    version: '0.3.8',
    title: 'Dottir v0.3.8 — renovasjonsprosjekt, transaksjoner og mer',
    body:
