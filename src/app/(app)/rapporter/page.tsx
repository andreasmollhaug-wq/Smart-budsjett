...
import { FileText, Target, ChevronRight, Sparkles, Wallet } from 'lucide-react'
      ...
      <div className="p-8 max-w-2xl flex flex-col gap-4">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm mt-1" style={{ color: 'var(--text-muted)' }}>
              Planlagte inntekter og utgifter for valgt år og person. PDF eller Excel (Excel på større skjerm).
            </p>
          </div>
          <ChevronRight size={20} style={{ color: 'var(--primary)' }} className="shrink-0" />
        </Link>
