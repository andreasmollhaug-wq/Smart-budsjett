...
import { Plus, Trash2, Target, Calendar, X, TrendingUp, ChevronRight } from 'lucide-react'
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setEditForm({ ...editForm, linkedBudgetCategoryId: e.target.value })
                      }
                      className="w-full px-3 py-2 rounded-xl text-sm"
                      style={{ border: '1px solid var(--border)', background: 'var(--bg)', color: 'var(--text)' }}
                    >
